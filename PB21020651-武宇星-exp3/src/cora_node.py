...
dataset = Planetoid(root='//data/wuyux', name='cora', transform=NormalizeFeatures())
...
val_losses = []
best_val_acc = 0
best_model_path = "dl/pytorch/exp3/param/cora_node_classification.pth"
...
plt.grid(True)
plt.savefig("dl/pytorch/exp3/param/cora_node_classification_loss.png")   