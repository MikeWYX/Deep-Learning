...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.shortcut1 = nn.Sequential(nn.Conv2d(3, 64, 1), nn.BatchNorm2d(64))
        self.shortcut2 = nn.Sequential(nn.Conv2d(64, 128, 1), nn.BatchNorm2d(128))
        self.shortcut3 = nn.Sequential(nn.Conv2d(128, 256, 1), nn.BatchNorm2d(256))
